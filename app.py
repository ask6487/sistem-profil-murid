...
st.set_page_config(page_title="Sistem Data Pelajar", layout="wide")
        ...
        <div class="official-header">
            <div style="display: flex; align-items: center;">
                ...
                <div>
                    ...
                    <div class="school-info">KODSEK123 | SMK SULTAN ALAUDDIN</div>
                </div>
            </div>
        </div>
    """, unsafe_allowed_html=True)
        ...
        <div class="print-container">
            ...
            <div class="page-break">
                <div style="border-bottom: 3px double #000; padding-bottom: 10px; margin-bottom: 30px; text-align: center;">
                    ...
                    <p><b>SMK SULTAN ALAUDDIN (KODSEK123)</b></p>
                </div>
