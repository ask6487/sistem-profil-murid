...
# ==========================================
    ...
    if st.session_state['df_pelajar'] is None:
        st.warning("Sila muat naik fail database di Page 1 terlebih dahulu.")
    else:
...
# ==========================================
    ...
    if 'murid_terpilih' not in st.session_state or st.session_state['df_pelajar'] is None:
        st.warning("Sila pilih murid di Page 2 terlebih dahulu.")
    else:
        ...
        if st.button("Cetak / Simpan ke PDF"):
        ...
        <div class="print-container">
            ...
            <div class="page-break">
                ...
                <table style="width:100%; border-collapse: collapse; margin-top: 15px;">
                    ...
                    <tr><td style="padding: 10px; border: 1px solid #ddd; font-weight:bold;">ID Murid</td><td style="padding: 10px; border: 1px solid #ddd;">{m.get('ID MURID', 'N/A')}</td></tr>
